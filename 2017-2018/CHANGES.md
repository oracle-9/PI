...
- Exercises `1.1` to `2.1 f)` were (excessively) commented to provide a detailed description;
...
- Os exercícios `1.1` a `2.1 f)` foram (excessivamente) comentados para fornecer uma descrição mais detalhada;
